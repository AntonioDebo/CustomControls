...
namespace CustomControls.ADControls
{
    public class ADButton: Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if(borderRadius>2) //Case Rounded button
            {
                ...
                using(Pen penBorder= new Pen(borderColor,borderSize))
                {
                    ...
                    //Button Border
                    if (borderSize>=1) { this.Region = new Region(rectSurface); }
                }
            }
            else //Case Square button
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            this.Parent.BackColorChanged += new EventHandler(Container_BackColorCahnged);
        }

        private void Container_BackColorCahnged(object sender, EventArgs e)
        {
